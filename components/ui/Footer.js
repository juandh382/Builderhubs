            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-lg-12 col-6'>
                        ...
                        <nav className="navbar navbar-expand-lg">
                            <div className="container-fluid">
                                <div className="navbar-nav">
                                    ...
                                    <a className="nav-link ps-0" href="#">Products</a>
                        ...
                        <ul id='media-links-container' className='list-group list-group-horizontal' >
                    ...
                    <div id='languages' className='col-lg-12 col-6'>
